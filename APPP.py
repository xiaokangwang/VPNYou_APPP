...
# -*- coding: utf-8 -*-
#
# VPNYou_APPP a fork of APPP to help VPNYou's User
# APPP (PYTHON IMPLEMENTATION OF APJP http://code.google.com/p/apjp/)
#
# Copyright @ 2013 XiaokangWang
# forked from Fartersoft 
#
...
def main():
	...
	if servers == [] and runall == False:
		...
		#sys.exit(1)
		#since designed for VPNYou, we will choose the VPNYou if nothing was chosen
		servers = ["vpnyou"]
